    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-register">Register a new patient and send OTP</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-request-otp">
                                <a href="#endpoints-POSTapi-v1-auth-request-otp">Send OTP to user's phone for login</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-verify-otp">
                                <a href="#endpoints-POSTapi-v1-auth-verify-otp">Verify OTP and authenticate user</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-logout">Logout user (revoke token)</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-v1-auth-register">Register a new patient and send OTP</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^(+?[0-9]{8,15}. Must not be greater than 20 characters. Example: <code>qxbajwbpilpmufinl</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="language"                data-endpoint="POSTapi-v1-auth-register"
               value="english"
               data-component="body">
    <br>
<p>Example: <code>english</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>fr</code></li> <li><code>moore</code></li> <li><code>dioula</code></li> <li><code>english</code></li></ul>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-v1-auth-request-otp">Send OTP to user&#039;s phone for login</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/auth/request-otp" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"phone\": \"(562771717728\"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^(+?[0-9]{8,15}. Example: <code>(562771717728</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-v1-auth-verify-otp">Verify OTP and authenticate user</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be 6 characters. Example: <code>vmqeop</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-logout">Logout user (revoke token)</h2>
