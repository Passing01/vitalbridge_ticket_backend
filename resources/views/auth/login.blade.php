                            ...
                            <div class="flex-auto p-6">
                                <form method="POST" action="{{ route('login') }}" role="form">
                                    ...
                                    <div class="min-h-6 mb-0.5 block pl-12">
                                        ...
                                        <label class="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700" for="remember_me">
                                            {{ __('Remember me') }}
                                        </label>
                                    </div>
                                    ...
                                    @if (Route::has('password.request'))
                                        <p class="mt-4 mb-0 leading-normal text-sm">
                                            ...
                                            <a href="{{ route('password.request') }}" class="font-bold text-slate-700">
                                                {{ __('Reset it here') }}
                                            </a>
                                        </p>
                                    @endif
