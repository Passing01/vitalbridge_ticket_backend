<nav
        ...
        <div
          ...
          <nav>
            ...
            <!-- <div class="header-element flex items-center ms-2">
              <h6 class="mb-0 font-bold text-gray-700">
          ...
          <div
            ...
            <ul
              ...
              <li class="flex items-center px-4">
                <div class="inline-block px-6 py-3 mb-0 ml-6 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs bg-gradient-to-tl from-purple-700 to-pink-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md">
                  <!-- <div class="relative">
                    <div class="h-9 w-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-semibold shadow-sm">
              ...
              <li class="flex items-center ml-2">
                <form method="POST" action="{{ route('logout') }}">
                  @csrf
                  <button type="submit" class="flex items-center px-4 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200 group">
                    <i class="fas fa-sign-out-alt mr-2 text-gray-400 group-hover:text-gray-600 transition-colors"></i>
                    {{ __('Déconnexion') }}
                  </button>
                </form>
              </li>
