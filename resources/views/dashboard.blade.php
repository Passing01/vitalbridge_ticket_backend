              ...
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans text-sm font-semibold leading-normal">Patients en attente</p>
                      <h5 class="mb-0 font-bold">{{ $pending ?? 0 }}</h5>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
                    <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-yellow-400 to-orange-500">
                      <i class="ni ni-watch-time text-lg relative top-3.5 text-white"></i>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans text-sm font-semibold leading-normal">Patients en consultation</p>
                      <h5 class="mb-0 font-bold">{{ $in_consultation ?? 0 }}</h5>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
                    <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-green-400 to-blue-500">
                      <i class="ni ni-user-md text-lg relative top-3.5 text-white"></i>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans text-sm font-semibold leading-normal">Patients absents</p>
                      <h5 class="mb-0 font-bold">{{ $absent ?? 0 }}</h5>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
                    <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-red-400 to-pink-500">
                      <i class="ni ni-user-run text-lg relative top-3.5 text-white"></i>
                    </div>
                  </div>
                </div>
              </div>
