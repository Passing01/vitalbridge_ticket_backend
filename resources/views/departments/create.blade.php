...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Ajouter un département</h1>
        <p class="text-gray-600">Remplissez les informations ci-dessous pour ajouter un nouveau département.</p>
    </div>
